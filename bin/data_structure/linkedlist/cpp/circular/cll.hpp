...
CircularLinkedList<T>::~CircularLinkedList() 
{
  ...
  template <class T>
void CircularLinkedList<T>::link(Node<T> *curr, Node<T> *newNode)
{
  ...
  template <class T>
void CircularLinkedList<T>::insert_back(int val) 
{
  if (capacity == 0) 
  {
    last = new Node<T>(val);
  ...
  template <class T>
void CircularLinkedList<T>::insert_front(int val) 
{
  if (capacity == 0) 
  {
    insert_back(val);
  ...
  template <class T>
void CircularLinkedList<T>::insert_at(int index, int val) 
{
  if (capacity == 0) 
  {
    insert_back(val);
...
void CircularLinkedList<T>::remove_back()
{
  ...
  template <class T>
void CircularLinkedList<T>::remove_at(int index)
{
  if (capacity == 0) 
  {
    cerr << "List is empty..." << endl;
